...
image-flash-$(PLATFORM):
	$(PYTHON) $$(which panologic_g2Config.py) $(PROG_PORT) $(IMAGE_FILE)

# Gateware
gateware-load-$(PLATFORM):
	@echo "panologic_g2 doesn't support loading, use the flash target instead."
...
gateware-flash-$(PLATFORM): $(GATEWARE_BIOS_FILE)
	$(PYTHON) $$(which panologic_g2Config.py) $(PROG_PORT) $(GATEWARE_BIOS_FILE)
...
firmware-flash-$(PLATFORM):
	@echo "panologic_g2 doesn't support just flashing firmware, use image target instead."
