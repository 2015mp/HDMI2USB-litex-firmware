...
class _CRG(Module):
    def __init__(self, platform, clk_freq):
        ...
        # Input 100MHz clock
        f0 = 125*1000000
        clk100 = platform.request("clk125")
        clk100a = Signal()
...
class BaseSoC(SoCSDRAM):
    ...
    def __init__(self, platform, **kwargs):
        ...
        self.submodules.ddrphy0 = s6ddrphy.S6HalfRateDDRPHY(
            platform.request("ddram"),
            sdram_module.memtype,
            rd_bitslip=0,
            wr_bitslip=4,
            dqs_ddr_alignment="C0")
        #self.submodules.ddrphy1 = s6ddrphy.S6HalfRateDDRPHY(
        #    platform.request("ddram"),
        #    sdram_module.memtype,
        #    rd_bitslip=0,
        #    wr_bitslip=4,
        ...
        controller_settings = ControllerSettings(
            with_bandwidth=True)
        self.register_sdram(self.ddrphy0,
                            sdram_module.geom_settings,
                            sdram_module.timing_settings,
                            controller_settings=controller_settings)
        self.comb += [
            self.ddrphy0.clk4x_wr_strb.eq(self.crg.clk4x_wr_strb),
            self.ddrphy0.clk4x_rd_strb.eq(self.crg.clk4x_rd_strb),
            #self.ddrphy1.clk4x_wr_strb.eq(self.crg.clk4x_wr_strb),
            #self.ddrphy1.clk4x_rd_strb.eq(self.crg.clk4x_rd_strb),
        ]
